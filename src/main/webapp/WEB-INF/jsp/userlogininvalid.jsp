...
<html>
    ...
    <body>
        <div class="wrapper">
                            ...
                            <div class="right">
                                <main>
                                    <div class="input-field">
                                        <ul>
                                            <form action="loginformuser" method="post" >
                                        ...
                                        <a href="userpasswordreset"><h6 id="fgtp"> Forgot password? </h6></a>
                                    </div>
                                </main>
                            </div>
                        </div>
            ...
            <div id="sign-up-main">
                <div class="call-text">
                    <div class="invalid"> <b>Invalid Credentials! </b></div>
                    <h1>Show us your <span>creative</span> side</h1>

                    <a href="userregister"> <div class="sign_up_1">
