    ...
    <body >
        ...
        <div class="main-content" id="sidebar_shrink4">
            ...
            <div class="m-v">
                ...
                <form action = "updateuserfirstname">
                ...
                <form action = "updateuserlastname">
                ...
                <form action = "updateuserbirthdate">
                ...
                <form action = "updateusermobailno">
                ...
                <form action = "updateusermedicalhistory">
                ...
                <form action = "updateuseradharnumber">
