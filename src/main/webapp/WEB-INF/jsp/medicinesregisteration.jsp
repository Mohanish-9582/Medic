    ...
    <body >
        ...
        <div class="main-content" id="sidebar_shrink4">
            ...
            <main id="sidebar_shrink5">
                <form action="registerformmedicines" method="post">
                    <div class="form_wrapper">

                        <div class="form_container">
                            <div class="title_container">
                                <h2>Medicines Registration Form<br></h2>
                                <br>
                                <br>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <div class="input-container">
                                        ...
                                        <input class="input-field" type="text" placeholder="Serial no" name="a" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-container">
                                        <i class="a las la-hospital icon"></i>
                                        <input class="input-field" type="text" placeholder="Total Available medicines" name="e" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-container">
                                <i class="a las fa fa-wheelchair icon" style="font-size:24px"></i>
                                <input class="input-field" type="text" placeholder="Type of medicines name" name="b" required>
                            </div>
                            <div class="input-container">
                                <i class="a las fa fa-medkit icon" style="font-size:24px"></i>
                                <input class="input-field" type="text" placeholder="medicine name" name="c" required>
                            </div>
                            <div class="input-container">
                                <i class="a las fa fa-plus-square icon" style="font-size:24px"></i>
                                <input class="input-field" type="text" placeholder="Use of Medicines" name="d" required>
                            </div>
