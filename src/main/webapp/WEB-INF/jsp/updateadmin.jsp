...
<html lang="en">
    ...
    <body >
        ...
        <div class="main-content" id="sidebar_shrink4">
            ...
            <form action = "updateadminfirstname">
            ...
            <form action = "updateadminlastname">
            ...
            <form action = "updateadminbirthdate">
            ...
            <form action = "updateadminaddress">
            ...
            <form action = "updateadminmobailno">
...
<script>
    ...
    let xy9 = document.getElementById("sidebar_shrink29");//main
                    ...
                    let modalcontentId10 = document.getElementById("deleteModal");
                    let myModal1Shift10 = document.getElementById("myModalDelete");
