...
<html lang="en">
    <head>
        ...
        <style>
            ...
            *{
            ...
            .lab-background{
                background-image: url(https://images.unsplash.com/photo-1606206873764-fd15e242df52?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80) ;
                opacity:.9;
                /* height: 700px; */
                width: 100%;
                border-radius: 7px;
    ...
    <body >
        ...
        <div class="main-content" id="sidebar_shrink4">
            <header id="sidebar_shrink3">
                ...
                <h2>
                    <label for="">
                        ...
                        <span id="Dash-logo">   <a href="laboratory"> Hospital Laboratory Management </a></span>  </span>
                    </label>                    
                </h2>
                <!-- </div> -->
                ...
                <div class="contain">
                    <section class="section1">
                        <div class="lab-background">
                            <h1 class="dscrp-tlt1">Hospital Laboratories Management</h1>                    
                        </div>
                    </section>


                    <section class="section2">
                        <h2 class="dscrp-tlt2">Information About Laboratories</h2>
                        <div class="cards-for-work Reveal">

                            <fieldset>
                                <div class="card text-center" style="width: 18rem;">
                                    <legend id="lgnd-1" class="scheduler-border">.Labs</legend>
                                    <div class="card-body">
                                        <h5 class="card-title">4</h5>
                                        <p class="card-text">Total number of different Laboratories in hospital</p>
                            ...
                            <fieldset>
                                <div class="card text-center" style="width: 18rem;">
                                    <legend id="lgnd-2" class="scheduler-border">.Doctors</legend>
                                    <div class="card-body">
                                        <h5 class="card-title">11</h5>
                                        <p class="card-text">Total Doctors Working in Laboratories</p>
                            ...
                            <fieldset>
                                <div class="card text-center" style="width: 18rem;">
                                    <legend id="lgnd-3" class="scheduler-border">.Assistant</legend>
                                    <div class="card-body">
                                        <h5 class="card-title">24</h5>
                                        <p class="card-text">Total Assistants Working in Laboratories</p>
            ...
            <section class="section2">
                <div class="m-v" id="mvId">

                    <span class="dscrp-tlt2"> <h3 id="vis" class="dscrp-tlt">Consequence</h3></span>
                    <span> <p> Making sure that results of all lab tests are accurate and timely ensures that patients are able to get the best care as quickly as possible.</p></span>
                </div>
        </div></section>
