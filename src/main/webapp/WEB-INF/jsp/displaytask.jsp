        ...
        <div class="main-content" id="sidebar_shrink4">
            ...
            <main id="sidebar_shrink5">
                <div class="container" id="containerId">
                    ...
                    <div class="task-btn">
                        <form action="previousproblem">
                            <div class="task">
                                <input type="submit" value="<< Previous Task">
                            </div>
                        </form>
                        <form action="nextproblem">
                            <div class="task1">
                                <input type="submit" value=" Next Task >>">
                            </div>
                        </form></div>

                    <div class="task2" id="sidebar_shrink59">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-center">
                            ...
                            <form action="deleteproblem">
                                <a href="deleteproblem" ><button type="button" class="btn btn-danger">Delete</button> </a>
                            </form>
                        </div>
                    </div>
                </div>
