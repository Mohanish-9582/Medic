    ...
    <head>
        ...
        <style>
            ...
            *{
            ...
            #delete-btn:hover{
                background-color: #0b0eae;
                border: 1px rgb(199, 187, 187);
            }
            #up-btn{
                position: relative;
                top: 0;
                display: inline;
                background-color: #1ef846;
                left: 10px;
                /*height: 48px;*/
                transition: all 0.3s ease-in-out;
            }
                    ...
                    <table  style="width:220%">
                        ...
                        <tr>
                            <%
                                ...
                                List<String> l10 = (List<String>) request.getAttribute("l10");
                                List<String> l11 = (List<String>) request.getAttribute("l11");
                                List<String> l12 = (List<String>) request.getAttribute("l12");
                                List<String> l13 = (List<String>) request.getAttribute("l13");
                            ...
                            <%                        int i = 0;
                                for (String o : l1) {
                                    ...
                                    out.print("<tr>"
                                            ...
                                            + "<td>" + "<a href=#myModal1 data-toggle=modal>&#128260</a>" + "</td> "
                                            + "</tr>");
                                    i++;
                                }
                            %>       
                ...
                <div class="modal-dialog modal-confirm">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-center">
                            ...
                            <div class="search-wrapper" align ="center">
                                <form action="updateuser_1">
                                    <input type="text"
                                           placeholder=" Enter id you want to delete"
                                           name="d" required>
                                    <input type="submit" class="btn btn-danger1" id="up-btn" value="Update"/> 
                                </form>
                            </div>
                        </div>
                    </div>
